...
<div class="row page-title">
    <div class="col-md-12">
        ...
        <h4 class="mb-1 mt-0">Agregar rol</h4>
    </div>
</div>
@endsection
            ...
            <div class="card-body">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputNombre" name="name" value="{{ old('name', isset($role) ? $role->name : '') }}" maxlength="70" autocomplete="off">
                    </div>
                    ...
                    <div class="form-group mt-3 mt-xl-0">
                        ...
                        <select name="permission[]" id="permission" data-plugin="customselect" class="form-control select2" multiple>
