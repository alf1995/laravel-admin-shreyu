    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('settings.update', $setting->id) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                @method('PUT')
                {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputNombre" name="title" value="{{old('title', $setting->title)}}" maxlength="100" autocomplete="off">
                    </div>
                  
                    <div class="form-group">
                        <label class="" for="example-fileinput">Favicon: (Max:50px*50px)</label>
